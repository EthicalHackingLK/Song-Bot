...
TOKEN = os.environ.get("5452648544:AAFhZ8kDvn5Qeb_uZtmrcrFvA9XlIn79MDw")
...
class Chat:
    def __init__(self, msg):
        ...
        self.user_input = self.user_input.replace('@slofficialcommunity', '')
        ...
        self.messages = {
            ...
            'spotify_input_error':"‼️ *Oops! The bot doesn't support Spotify links!*\n"
                    ...
                    'or: "*/song* _songian name - song name_"',
